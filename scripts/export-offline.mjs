...
const favicon='data:image/svg+xml,'+encodeURIComponent(await fs.readFile(path.join(project,'public/favicon.svg'),'utf8'));
const html='<!doctype html><html lang="en" class="dark"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="'+escape(siteDescription)+'"><title>'+escape(siteTitle)+'</title>'+seo+'<link rel="icon" type="image/svg+xml" href="'+favicon+'"><style>'+css+'</style></head><body><div id="root"></div><noscript>Please enable JavaScript to use Spectrum.</noscript><script>'+script+'</script></body></html>';
